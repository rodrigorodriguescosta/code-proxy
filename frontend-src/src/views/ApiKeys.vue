      ...
      <div v-for="key in keys" :key="key.id"
        ...
        <div class="flex items-center justify-between mb-2">
          <div class="flex items-center gap-2">
            ...
            <span :class="key.is_active ? 'bg-green-400/10 text-green-400' : 'bg-gray-500/10 text-gray-500'"
        ...
        <div v-if="key.key" class="flex items-center gap-2">
          <code class="flex-1 px-3 py-1.5 rounded text-xs font-mono truncate select-all"
                :class="props.theme === 'light' ? 'bg-gray-50 text-gray-600' : 'bg-gray-950 text-gray-400'">{{ key.key }}</code>
