    ...
    <template v-else-if="stats">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="border rounded-xl p-5"
          ...
          <p class="text-3xl font-bold text-blue-400 mt-2">{{ fmtNum(stats.total_input_tokens) }}</p>
        </div>
        <div class="border rounded-xl p-5"
             :class="props.theme === 'light' ? 'bg-white border-gray-200' : 'bg-zinc-900 border-zinc-800/40'">
      ...
      <!-- Metric toggle -->
      <div class="flex gap-1 p-1 rounded-lg w-fit mb-4" :class="props.theme === 'light' ? 'bg-gray-100' : 'bg-zinc-900'">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div v-if="stats.per_key?.length" class="border rounded-xl p-5"
            ...
            <div class="mt-4 pt-4 border-t" :class="props.theme === 'light' ? 'border-gray-100' : 'border-zinc-800/50'">
          ...
          <div class="border rounded-xl p-5"
            ...
            <div class="rounded-lg p-4 font-mono text-sm space-y-1"
                 :class="props.theme === 'light' ? 'bg-gray-50 text-gray-700' : 'bg-zinc-950 text-gray-300'">
